...
df=pd.read_csv('../DataCollection-RED-Largedataset-Training/OGP_dataset_collection_Rmatrix_RED.csv', names=['image_name', 'mat00', 'mat10', 'mat20','mat01','mat11','mat21','position_X', 'position_Y', 'position_Z'], header=None)
...
class ClothDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        OGP_pose[0,6]=(OGP_pose[0,6]-min_position_X)/(max_position_X-min_position_X)
        OGP_pose[0,7]=(OGP_pose[0,7]-min_position_Y)/(max_position_Y-min_position_Y)
...
cloth_dataset = ClothDataset(csv_file='../DataCollection-RED-Largedataset-Training/OGP_dataset_collection_Rmatrix_RED.csv',root_dir='../DataCollection-RED-Largedataset-Training/')
validation_split = .2
...
writer = SummaryWriter('Rmatrix_graphs/OGP_trainer_0.001LR_RealTest{}_time_{}'.format(EPOCHS,timestamp))
...
for epoch in range(EPOCHS):
    ...
    if min_valid_loss > valid_loss:
        ...
        torch.save(model.state_dict(), 'OGP_saved_model_Full_0.001LR_Rmatrix.pth')
